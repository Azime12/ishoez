...
const Header = () => {
  ...
  return (
    <header className="bg-gradient-to-r from-emerald-100 via-[#99CC33] via-[#289728] to-[#004400] sticky top-0 z-50">
      <nav className="container flex items-center justify-between px-4 py-3 mx-auto">
        {/* Logo */}
        <Link to="/" className="flex items-center">
          <img src="/images/logo.png" alt="Wellness world Logo" className="w-auto h-20 p-2 rounded-full" />
        </Link>
